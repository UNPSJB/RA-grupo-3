    ...
    switch (pregunta.tipo) {
      ...
      case "MULTIPLE_CHOICE":
        if (!pregunta.opciones || pregunta.opciones.length === 0) {
          return <p className="text-red-500">Error: No se proporcionaron opciones para esta pregunta.</p>;
        }
        return (
      ...
      default:
        ...
        return <p className="text-red-500">Error: Tipo de pregunta no soportado ({pregunta.tipo})</p>;
    }
  };
    ...
    <div className="bg-white border border-gray-200 rounded-lg shadow-sm mb-4 transition-all duration-300">
      ...
      >
                <span className="flex items-center">
                  <span className="w-5 h-5 mr-2 flex items-center justify-center"> {/* Container for the tick */}
